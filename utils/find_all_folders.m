function p = find_all_folders(d)
% i will never understand hiding folders and code from programmers....
%
...
if nargin==0,
  p = find_all_folders(fullfile(matlabroot,'toolbox'));
...
for i=1:length(dirs)
   ...
   if    ~strcmp( dirname,'.')          && ...
      ...
      p = [p find_all_folders(fullfile(d,dirname))]; % recursive calling of this function.
   end
end
